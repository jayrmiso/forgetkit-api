    ...
    schemas: {
      ...
      Workspace: {
        ...
        properties: {
          ...
          cameraView: { type: ["string", "null"], enum: ["unknown", "top_down", "side_scroller", "isometric", "first_person", "third_person", null] },
          artDirection: { type: ["string", "null"] },
          targetResolution: { type: ["string", "null"] },
          defaultBiome: { type: ["string", "null"] },
          defaultStyle: { type: ["string", "null"] },
          currentFocus: { type: ["string", "null"] },
          nextMilestone: { type: ["string", "null"] },
          blockers: { type: ["string", "null"] },
          storageRootPath: { type: ["string", "null"] },
          godotProjectPath: { type: ["string", "null"] },
          namingConvention: { type: ["string", "null"] },
      ...
      UpdateWorkspaceRequest: {
        ...
        properties: {
          ...
          engineTarget: { type: "string", enum: ["unknown", "godot"] },
          visibility: { type: "string", enum: ["private", "unlisted", "public"] },
          gameTitle: { type: ["string", "null"], maxLength: 240 },
          genre: { type: ["string", "null"], maxLength: 240 },
          cameraView: { type: ["string", "null"], enum: ["unknown", "top_down", "side_scroller", "isometric", "first_person", "third_person", null] },
          artDirection: { type: ["string", "null"], maxLength: 1000 },
          targetResolution: { type: ["string", "null"], maxLength: 240 },
          defaultBiome: { type: ["string", "null"], maxLength: 240 },
          defaultStyle: { type: ["string", "null"], maxLength: 240 },
          currentFocus: { type: ["string", "null"], maxLength: 1000 },
          nextMilestone: { type: ["string", "null"], maxLength: 1000 },
          blockers: { type: ["string", "null"], maxLength: 1000 },
          storageRootPath: { type: ["string", "null"], maxLength: 240 },
          godotProjectPath: { type: ["string", "null"], maxLength: 240 },
          namingConvention: { type: ["string", "null"], maxLength: 1000 },
        },
      },
      SearchUserResult: {
        type: "object",
